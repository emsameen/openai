...
function registerCommands(context) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("reqai.swfCheckRequiremenets", () =>
        commandCallback("swfCheckRequiremenets")
    )
  );

  context.subscriptions.push(
    vscode.commands.registerCommand("reqai.swfGenerateTests", () =>
        commandCallback("swfGenerateTests")
    )
  );
